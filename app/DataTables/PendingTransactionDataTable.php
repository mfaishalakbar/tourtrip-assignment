    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->addColumn([
                        ...
                        'searchable' => false,
                        'orderable' => false,
                        'render' => "function() {return `<a href='/admin/transaction/` + this.transaction_id + `/view'>View</a> | <a href='/admin/transaction/` + this.transaction_id + `/approve'>Approve</a> | <a href='/admin/transaction/` + this.transaction_id + `/revoke'>Revoke</a>`}",
                        'footer' => 'Action',
                        'exportable' => false,
                        'printable' => false,
                    ]);
