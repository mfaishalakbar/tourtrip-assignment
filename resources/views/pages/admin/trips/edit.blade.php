    ...
    <div class="card-body">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" value="{{ old('days', $data->days) }}" class="form-control @error('days') is-invalid @enderror" name="days">
            ...
            <div class="form-group">
                ...
                <input type="number" value="{{ old('price', $data->price) }}" class="form-control @error('price') is-invalid @enderror" name="price">
            ...
            <div class="form-group">
                ...
                <select class="form-control item-id" name="city">
                    ...
                    <option @if(old('city', $data->city_id) == $city->id) selected @endif value="{{$city->id}}">{{$city->name}}</option>
                    @endforeach
                </select>
            @error('city')
                <span class="invalid-feedback" role="alert">
